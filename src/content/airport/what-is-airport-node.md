...
category: 机场知识
tags: [机场, 节点]
related: ["vpn/what-is-node", "airport/what-is-airport", "airport/airport-test-metrics"]
---
...
- **线路类型**：如IEPL/IPLC（国际私有专线，稳定性较好但成本高）、BGP中转（多为公共网络路由，成本较低）。
...
节点在技术上运行某种代理协议，常见的包括 Shadowsocks、VMess、VLESS、Trojan、Hysteria2 等。不同协议在抗封锁能力、连接效率上各有特点，但对普通用户来说，协议细节通常由服务商预先配置好，不需要手动选择——除非你使用sing-box等客户端自己搭建或深度定制，可参考[sing-box基础教程](/guide/singbox-basics/)。
